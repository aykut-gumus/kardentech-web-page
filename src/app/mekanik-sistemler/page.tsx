...
export const metadata: Metadata = {
  title: 'Mekanik Sistemler | Kardentech Mühendislik Bodrum',
  description: "Kardentech Mühendislik'in mekanik uygulama alanı ve ilgili proje deneyimlerini inceleyin.",
};
