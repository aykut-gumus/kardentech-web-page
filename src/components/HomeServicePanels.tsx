      ...
      <div className="hidden md:block w-full h-full flex-1 relative overflow-hidden isolate bg-transparent group/panels">
        ...
        >
          ...
          >
            ...
            <h2 className={`text-3xl lg:text-4xl 2xl:text-5xl font-medium  tracking-[-0.005em] text-white uppercase drop-shadow-md ${(lang === 'ru' || lang === 'en') ? 'mb-6 leading-[1.08] text-center' : 'mb-7 leading-[1.08] whitespace-nowrap'}`}>
              {lang === 'en' ? (
                <>FINISHING<br />WORKS</>
              ) : lang === 'ru' ? (
