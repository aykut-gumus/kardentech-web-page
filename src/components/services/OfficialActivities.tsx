...
export default function OfficialActivities() {
  const activities = [
        ...
        <div className="flex flex-col border-t border-[var(--color-medium-gray)]">
          {activities.map((item) => (
            ...
            >
              ...
              <h3 className="text-xl md:text-2xl font-bold text-[var(--color-charcoal)] tracking-wide flex-1">
                {item.title}
              </h3>
            </div>
          ))}
